...
export const InventoryAddPanel: React.FC<InventoryAddPanelProps> = ({
  ...
  // --- SỬA LỖI 1: Bỏ useEffect reset form tại đây ---
  ...
  return (
    <Modal
      ...
      centered
      footer={null}
      destroyOnClose={true} // Tự động reset Form Antd khi đóng
    ...
    >
      ...
      <div className="bg-[#D4E5E4] rounded-xl p-8 relative" style={{ zIndex: 1 }}>
        ...
        <div className="flex justify-center mt-8">
          <Button type="primary" onClick={handleSubmit} className="h-12 px-20 rounded-2xl bg-[#1a998f] text-2xl font-bold border-none hover:bg-[#158f85]">Thêm Hàng hóa</Button>
        </div>
      </div>
    </Modal>
  );

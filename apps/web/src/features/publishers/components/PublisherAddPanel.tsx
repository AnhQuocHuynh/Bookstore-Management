    ...
    return (
        ...
        >
            ...
            <div className="bg-[#D4E5E4] rounded-xl p-8 relative" style={{ zIndex: 1 }}>
                <h2 className="text-center text-3xl font-bold text-[#102e3c] mb-8">Thêm Nhà Xuất Bản Mới</h2>

                <div className="flex justify-center">
                    <div className="w-full max-w-3xl">
                        <Form form={form} layout="vertical" requiredMark={false} className="space-y-4" onValuesChange={() => setIsDirty(true)}>
                            <Form.Item name="name" label={<span className="text-lg font-semibold text-[#102e3c]">Tên Nhà Xuất Bản:</span>} rules={[{ required: true, message: "Vui lòng nhập tên" }]}>
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                ...
                                <Form.Item name="website" label={<span className="text-lg font-semibold text-[#102e3c]">Website:</span>} rules={[{ type: 'url', message: "Phải là link hợp lệ (https://...)" }]}>
                                    <Input className="border-0 border-b-2 border-[#102e3c] rounded-none bg-transparent text-lg px-0 focus:shadow-none hover:border-[#1a998f] focus:border-[#1a998f]" placeholder="https://..." />
                                </Form.Item>
                            </div>
